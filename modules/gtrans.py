...
def module1_functions():
    print("Демонстрація роботи функцій пакету з першого модуля:")
    ...
    translated_text = module1.TransLate(text_to_translate, target_language)
    ...
    detected_language = module1.LangDetect(text_for_detection)
